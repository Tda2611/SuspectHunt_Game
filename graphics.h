...
struct Graphics {
    ...
    void renderText(Graphics& graphics, const char* text, TTF_Font* font, SDL_Color color, int x, int y){
        SDL_Texture* textTexture = graphics.renderText(text, font, color);
